...
# how to register a service on eureka server

https://www.google.com/search?q=how+to+register+a+service+on+eureka+server&oq=how+to+register+a+service+on+eureka+server&aqs=chrome..69i57j0l2.56185j0j7&sourceid=chrome&ie=UTF-8
